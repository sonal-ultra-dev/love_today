  ...
  return (
    <div className="space-y-5">
      {sections.map((section, index) => (
        <article
          key={section.title}
          className="group rounded-2xl border border-ink/10 bg-white/70 backdrop-blur-sm p-6 sm:p-7 shadow-sm hover:shadow-md hover:border-[#F6761B]/20 transition-all duration-300"
        >
